  ...
  <Container>
    ...
    <Container alignContent="center" alignItems="center">
      ...
      <Container maxWidth={['100%', '720px']} marginY="2rem">
        <Text>I&apos;m a Full-Stack developer living in Kochi.</Text>
        <Text>
          During my free time I like going for a stroll, being goofy, make web Designs and aesthetic feeds. You can stay updated with my life 
          by following &nbsp;
          <a href="https://www.instagram.com/hxnn.ly/">Instagram</a>.
        </Text>
      </Container>
    </Container>
